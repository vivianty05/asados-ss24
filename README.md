...
```
cd existing_repo
git remote add origin https://mygit.th-deg.de/mmayer/asados-ss24.git
git branch -M main
...
- [ ] [Set up project integrations](https://mygit.th-deg.de/mmayer/asados-ss24/-/settings/integrations)
